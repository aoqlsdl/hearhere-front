...
const ASMRList = ({ asmr }: Props) => {
    ...
    return (
        <div className="w-[29.69rem] h-[33.5rem] 1440:h-[38.63rem] rounded-[49px] bg-primary-GRAY400 flex flex-col items-center justify-center cursor-pointer mr-[1.88rem]">
            ...
            <button
                ...
                onClick={() => handleRedirect(`/asmr/${asmr.id}`)}
            >
                Hear
            </button>
        </div>
