    ...
    useEffect(() => {
        ...
        waveSurfers.forEach((waveSurfer) => {
            ...
            waveSurfer.on("audioprocess", () => {
                ...
                setProgress((maxCurrentTime / totalDuration) * 100);
            });
        });
        ...
        <>
            ...
            <div>
                <div className="flex flex-row w-full justify-center items-center mt-[2.48rem]">
                    ...
                    <div
                        className="relative w-[29.44rem] h-1 bg-primary-BLACK300 cursor-pointer flex items-center"
                        onClick={handleProgressClick}
                    >
                        {/* Progress Bar */}
                        <div
                            className="h-1 w-[29.44rem] absolute top-0 left-0 bg-primary-BLACK300"
